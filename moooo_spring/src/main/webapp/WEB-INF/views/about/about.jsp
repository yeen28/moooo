...
<style type="text/css">
.right_wrap { position: absolute; top: 0px; width: 70%; font-size: 14px; list-style: disc; margin-left: 10px; background-color: rgba( 255, 255, 255, 0.8 );}
</style>
<!-- jQuery CDN -->
...
<jsp:include page="/WEB-INF/views/layout/header.jsp"/>
	...
	해당 프로젝트는 사용자들이 사고싶은 물건이나 팔고싶은 물건을 올릴 수 있습니다. 그리고 해당 사이트의 목적에 맞지 않게 사용하는 사용자는 신고할 수 있는 기능을 넣었습니다.<br/>
	...
	<a href="<%= commonUrl %>/notice/notice_list.do" style="color:#0000FF">[이동]</a>
	<p>관리자가 공지할 내용을 게시하면 사용자들이 확인할 수 있습니다.</p>
	<hr/>
	<h4><strong>사고싶어요</strong></h4>
	<a href="<%= commonUrl %>/want_buy/want_buy.do" style="color:#0000FF">[이동]</a>
	<p>사용자가 사고싶은 물품과 원하는 가격을 제시하여 게시글을 작성합니다.</p>
	<hr/>
	<h4><strong>팔아요</strong></h4>
	<a href="<%= commonUrl %>/want_sell/want_sell.do" style="color:#0000FF">[이동]</a>
