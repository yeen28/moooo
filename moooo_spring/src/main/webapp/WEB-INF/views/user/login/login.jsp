...
<div id="container">
	<form class="form-signin" id="frm" action="<%= commonUrl %>/user/login/login_proc.do" method="post">
        ...
        <label>아이디</label>
        <input value="sist" type="text" id="inputId" name="user_id" class="form-control" placeholder="아이디" autofocus>
        <div id="idView"></div>
		<label style="margin-top: 10px">비밀번호</label>
		<input value="123qwe" type="password" id="inputPassword" name="pass" class="form-control" placeholder="비밀번호">
        <div id="passView"></div>
